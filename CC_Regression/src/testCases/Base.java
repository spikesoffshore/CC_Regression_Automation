...
// Declaring member variables common among Test Classes	
	...
	public static ExtentReports report=new ExtentReports(System.getProperty("user.dir")+"/ExecutionReports/CurrentRunReport/CC AutomationReport.html",true);
...
//Function to Login to the Isla Server
...
//Function for CC Login
	public void CC_Login(WebDriver driver,String userName,String Password){
		
		driver.findElement(By.id("signinUsernameText")).sendKeys(userName);
		driver.findElement(By.id("signinPasswordText")).sendKeys(Password);
		driver.findElement(By.id("signinPasswordText")).sendKeys(Key.ENTER);
		//driver.findElement(By.id("signinFormButton")).submit();
		Sleep(5000);
...
//Base Class Constructor:
	...
	public void afterSuite() {
        ...
        try {
            ...
            String existingReportText= FileUtils.readFileToString(new File(System.getProperty("user.dir")+"/ExecutionReports/CurrentRunReport/CC AutomationReport.html"));
            ...
            String myAgainNewReport=  existingReportText.replace("BROWSERWA", "<a href=./BrowserInfo.PNG"+">"+"<img border=\"0\" src=./BrowserInfo.PNG"+" width=\"100\" height=\"50\"</a>");
            ...
            FileUtils.writeStringToFile(new File(System.getProperty("user.dir")+"/ExecutionReports/CurrentRunReport/CC AutomationReport.html"), myAgainNewReport);
		...
		try {
			...
			String myCurrentOldReport = FileUtils.readFileToString(new File((currentRunTimestampedFolder).getPath()+"/CC AutomationReport.html"));
            String mynewOldReport = myCurrentOldReport.replaceAll("CurrentRunReport", "OlderRuns/Report_"+currentRunTimestamp);
            FileUtils.writeStringToFile(new File(System.getProperty("user.dir")+"/ExecutionReports/OlderRuns/Report_"+currentRunTimestamp+"/CC AutomationReport.html"), mynewOldReport);
